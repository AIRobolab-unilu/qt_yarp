...
SET(CUDDIE_ADD_PACKAGING FALSE CACHE BOOL "Add code to support packaging")

############ BEGIN CODE FOR PACKAGING
IF (CUDDIE_ADD_PACKAGING)
...
INSTALL(DIRECTORY  ${CUDDIE_APPLICATIONS_PREFIX}/ DESTINATION . COMPONENT Applications)
...
SET(CPACK_COMPONENT_MODULES_DISPLAY_NAME "Cuddie Modules")
SET(CPACK_COMPONENT_MODULES_DESCRIPTION "A set of executables")

# Configuration for component "Applications"
SET(CPACK_COMPONENT_APPLICATIONS_DISPLAY_NAME "Cuddie Applications")
...
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Cuddie Software ")
...
SET(CPACK_PACKAGE_INSTALL_DIRECTORY "Cuddie${CPACK_PACKAGE_VERSION_MAJOR}.${CPACK_PACKAGE_VERSION_MINOR}.${CPACK_PACKAGE_VERSION_PATCH}")
IF(WIN32 AND NOT UNIX)
   set(CPACK_NSIS_MODIFY_PATH ON)
	
   SET(CPACK_NSIS_DISPLAY_NAME "Cuddie Software ver.${CPACK_PACKAGE_VERSION_MAJOR}.${CPACK_PACKAGE_VERSION_MINOR}.${CPACK_PACKAGE_VERSION_PATCH}")
   SET(CPACK_NSIS_HELP_LINK "http:\\\\\\\\www.cuddie.org")
   SET(CPACK_NSIS_URL_INFO_ABOUT "http:\\\\\\\\www.cuddie.org")
